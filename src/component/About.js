...
export default function About(props) {
    ...
    var [mode, setMode] = useState("Enable Dark Mode");
    var changeMode = ()=>{
  ...
  return (
    ...
    <div className="container my-5" style={{backgroundColor: props.mode==='dark'?'#042743':'white'}}>
    <h2>About Us</h2>
...
<div className="dark">
    <button className="btn btn-outline-info btn-dark" onClick={changeMode}>{mode}</button>
</div>
</div>
    </>
  );
